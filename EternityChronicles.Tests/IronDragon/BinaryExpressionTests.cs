...
namespace EternityChronicles.Tests.IronDragon {
    ...
    public class BinaryExpressionTests : DragonAbstractTestFixture {
        ...
        public void TestEqualTo(int x, int y, bool expected) {
            Assert.That(O(x, "==", y), NUnit.Framework.Is.EqualTo(expected));
        }
        ...
        public void TestLogicalAnd(bool x, bool y, bool expected) {
            Assert.That(L(x, "&&", y), NUnit.Framework.Is.EqualTo(expected));
        }
        ...
        public void TestCompare(int x, int y, int expected) {
            Assert.That(B(x, "<=>", y), NUnit.Framework.Is.EqualTo(expected));
        }

        [Test]
        public void TestAdd() {
            Assert.That(B(5, "+", 7), NUnit.Framework.Is.EqualTo(12));
        }

        [Test]
        public void TestBitwiseAnd() {
            Assert.That(B(2, "&", 1), NUnit.Framework.Is.EqualTo(0));
        }

        [Test]
        public void TestBitwiseInverse() {
            Assert.That(CompileAndExecute("~5"), NUnit.Framework.Is.EqualTo(~5));
        }

        [Test]
        public void TestBitwiseOr() {
            Assert.That(B(4, "|", 3), NUnit.Framework.Is.EqualTo(7));
        }

        [Test]
        public void TestBitwiseXor() {
            Assert.That(B(10, "^", 8), NUnit.Framework.Is.EqualTo(2));
        }

        [Test]
        public void TestComplexMath1() {
            Assert.That(CompileAndExecute("5+7*3"), NUnit.Framework.Is.EqualTo(26));
        }

        [Test]
        public void TestComplexMath2() {
            Assert.That(CompileAndExecute("(5 + 7) * 3;"), NUnit.Framework.Is.EqualTo(36));
        }

        [Test]
        public void TestComplexMath3() {
            Assert.That(CompileAndExecute("5 + (7 * 3) - 4;"), NUnit.Framework.Is.EqualTo(22));
        }
        ...
        public void TestComplexMath5() {
            Assert.That(CompileAndExecute("(5 << 3) + 3 * 5 ** (8 / 4) | 10;"), NUnit.Framework.Is.EqualTo(123));
        }

        [Test]
        public void TestComplexMath6() {
            Assert.That(CompileAndExecute("- 3 * 7;"), NUnit.Framework.Is.EqualTo(-21));
        }

        [Test]
        public void TestDivide() {
            Assert.That(B(100, "/", 5), NUnit.Framework.Is.EqualTo(20));
        }

        [Test]
        public void TestExp() {
            Assert.That(CompileAndExecute("3.0 ** 4.0;"), NUnit.Framework.Is.EqualTo(81));
        }
        ...
        public void TestIntegrationRuby() {
            ...
            Assert.That(Dragonsource.Execute(Dragonscope), NUnit.Framework.Is.EqualTo(7));
        }

        [Test]
        public void TestLogicalNot() {
            Assert.That(CompileAndExecute("!true;"), NUnit.Framework.Is.EqualTo(false));
        }

        [Test]
        public void TestModulus() {
            Assert.That(B(5, "%", 2), NUnit.Framework.Is.EqualTo(1));
        }

        [Test]
        public void TestMultiply() {
            Assert.That(B(10, "*", 17), NUnit.Framework.Is.EqualTo(170));
        }

        [Test]
        public void TestNegate() {
            Assert.That(CompileAndExecute("- - 3;"), NUnit.Framework.Is.EqualTo(3));
        }
        ...
        public void TestShiftLeft() {
            Assert.That(B(2, "<<", 2), NUnit.Framework.Is.EqualTo(8));
        }

        [Test]
        public void TestShiftRight() {
            Assert.That(B(2, ">>", 2), NUnit.Framework.Is.EqualTo(0));
        }

        [Test]
        public void TestSubtract() {
            Assert.That(B(7, "-", 5), NUnit.Framework.Is.EqualTo(2));
        }

        [Test]
        public void TestRegex1()
        {
            Assert.That(CompileAndExecute("r = %/(H(?<a>el+)o) ([A-Z](?<b>.+)d)./; x = 'Hello World!'; x =~ r; a;"), NUnit.Framework.Is.EqualTo("ell"));
        }
