...
namespace EternityChronicles.Tests.IronDragon {
    ...
    public class AccessTests : DragonAbstractTestFixture {
        ...
        public void TestAccessPreDecrement() {
            Assert.That(CompileAndExecute("x = [1,2,3]; --x[1];"), NUnit.Framework.Is.EqualTo(1));
        }

        [Test]
        public void TestAccessPreIncrement() {
            Assert.That(CompileAndExecute("x = [1,2,3]; ++x[1];"), NUnit.Framework.Is.EqualTo(3));
        }
        ...
        public void TestArrayAccess() {
            Assert.That(CompileAndExecute("i = [1,2,3]; x = 1; i[x];"), NUnit.Framework.Is.EqualTo(2));
        }
        ...
        public void TestArrayBinaryOp() {
            Assert.That(CompileAndExecute("a = [1,2]; a[1] += 2;"), NUnit.Framework.Is.EqualTo(4));
        }
        ...
        public void TestDictionaryBinaryOp() {
            Assert.That(CompileAndExecute("a = { :t => 1, :x => 2 }; a[:t] *= 4;"), NUnit.Framework.Is.EqualTo(4));
        }

        [Test]
        public void TestExpressionDictionary() {
            Assert.That(CompileAndExecute("x = 17; z = { x => 10 }; z[x];"), NUnit.Framework.Is.EqualTo(10));
        }
