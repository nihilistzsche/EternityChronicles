...
namespace EternityChronicles.Tests.IronDragon {
    ...
    public class ClassTests : DragonAbstractTestFixture {
        ...
        public void TestArrayAdd() {
            ...
            Assert.That(CompileAndExecute("a = []; a << 'hello'; a;"), NUnit.Framework.Is.EqualTo(expect));
        }
        ...
        public void TestBox() {
            ...
            var ftx = global::IronDragon.Dragon.Box(ft);
            Assert.That(ftx._fieldTest + ftx.x, NUnit.Framework.Is.EqualTo(37));
        }
        ...
        public void TestBoxAddInstanceMethod() {
            ...
            var ftx2 = global::IronDragon.Dragon.Box(ft2);
            ftx2.x = 15;
            Assert.That(ftx2.add_me(10), NUnit.Framework.Is.EqualTo(25));
        }
        ...
        public void TestBoxAddSingleton() {
            ...
            ftx.x = 15;
            Assert.That(ftx.y(10), NUnit.Framework.Is.EqualTo(25));
        }

        [Test]
        public void TestBoxExtension() {
            DragonClass strb = global::IronDragon.Dragon.Box(typeof (StringBuilder));
            var engine = GetRuntime().GetEngine("IronDragon");
            var defsource =
            ...
            var strx = global::IronDragon.Dragon.Box(str, new DragonScope(scope));
            strx.AppendFromDragon();
            Assert.That(str.ToString(),
                NUnit.Framework.Is.EqualTo("Hello world! Appending from Dragon extension method!"));
        }
        ...
        public void TestBoxInterface() {
            var iface = global::IronDragon.Dragon.Box(typeof (IComparable));
            var engine = GetRuntime().GetEngine("IronDragon");
            ...
            Assert.That(actual, NUnit.Framework.Is.Null);
        }
        ...
        public void TestBoxUnderlyingObject() {
            ...
            Assert.That(ft._fieldTest, NUnit.Framework.Is.EqualTo(25));
        }
        ...
        public void TestCSharpClassCallTwo() {
            ...
            val.Append(" world!");
            Assert.That(val.ToString(), NUnit.Framework.Is.EqualTo("hello world!"));
        }
        ...
        public void TestCSharpContructorMap() {
            ...
            Assert.That(defsource.Execute(defscope), NUnit.Framework.Is.EqualTo("Hello from Dragon!"));
        }
        ...
        public void TestClassInheritCSharp() {
            ...
            var scope = engine.CreateScope();
            scope.SetVariable("SVTestClass", global::IronDragon.Dragon.Box(typeof (SVTestClass)));
            Assert.That(source.Execute(scope), NUnit.Framework.Is.EqualTo(150));
        }
        ...
        public void TestClassInheritCSharpTwo() {
            ...
            var scope = engine.CreateScope();
            scope.SetVariable("SVTestClass", global::IronDragon.Dragon.Box(typeof (SVTestClass)));
            Assert.That(source.Execute(scope), NUnit.Framework.Is.EqualTo(340));
        }
        ...
        public void TestClassInheritDragon() {
            Assert.That(
                ...
                NUnit.Framework.Is.EqualTo("Hello world!"));
        }
        ...
        public void TestClassOverrideSimple() {
            Assert.That(
                ...
                NUnit.Framework.Is.EqualTo("Hello you!"));
        }
        ...
        public void TestClassOverrideSuper() {
            Assert.That(
                ...
                NUnit.Framework.Is.EqualTo("Hello me!"));
        }
        ...
        public void TestClassResolve() {
            Assert.That(CompileAndExecute("Math.Cos(90);"), NUnit.Framework.Is.EqualTo(Math.Cos(90)));
        }
        ...
        public void TestCustomOp() {
            ...
            var testClass = new DragonClass("Test", global::IronDragon.Dragon.Box(typeof (object)),
            ...
            Assert.That(source.Execute(scope), NUnit.Framework.Is.EqualTo(4));
        }
        ...
        public void TestDynamicIVarGetFromWrap() {
            ...
            defsource.Execute(defscope);
            var ftx = global::IronDragon.Dragon.Box(ft);
            Assert.That(ft._fieldTest + ftx.x, NUnit.Framework.Is.EqualTo(37));
        }
        ...
        public void TestDynamicIVarPersistance() {
            ...
            Assert.That(source.Execute(scope), NUnit.Framework.Is.EqualTo(32));
        }
        ...
        public void TestDynamicWrapPartialFunction() {
            ...
            var _x = global::IronDragon.Dragon.Box(x);

            var add = _x.add();

            Assert.That((int)add(10), NUnit.Framework.Is.EqualTo(40));
        }
        ...
        public void TestInstanceVar() {
            ...
            defscope.SetVariable("ft", new NativeHelper(0));
            Assert.That(defsource.Execute(defscope), NUnit.Framework.Is.EqualTo(27));
        }
        ...
        public void TestInvokeMember() {
            ...
            var testClass = new DragonClass("Test", global::IronDragon.Dragon.Box(typeof (object)), new List<DragonFunction>(),
            ...
            Assert.That(nsource.Execute(nscope), NUnit.Framework.Is.EqualTo(27));
        }
        ...
        public void TestInvokeMemberCSharp() {
            ...
            dynamic testClass = new DragonClass("Test", global::IronDragon.Dragon.Box(typeof (object)),
                new List<DragonFunction>(),
                new List<DragonFunction> {scope.GetVariable("test")});

            var x = testClass();

            Assert.That(x.test(17), NUnit.Framework.Is.EqualTo(27));
        }
        ...
        public void TestInvokeMemberIronRuby() {
            ...
            Assert.That(rubysource.Execute(rubyscope), NUnit.Framework.Is.EqualTo(27));
        }
        ...
        public void TestInvokeMemberIronRubyWithNewArg() {
            ...
            Assert.That(rubysource.Execute(rubyscope), NUnit.Framework.Is.EqualTo(39));
        }
        ...
        public void TestInvokeMemberMethodTable() {
            ...
            Assert.That(nsource.Execute(nscope), NUnit.Framework.Is.EqualTo(42));
        }
        ...
        public void TestInvokeMemberPartialFunctionIVarTest() {
            ...
            Assert.That(nsource.Execute(nscope), NUnit.Framework.Is.EqualTo(37));
        }
        ...
        public void TestInvokeMemberPartialFunctionIVarTestCSharp() {
            ...
            Assert.That(px(17), NUnit.Framework.Is.EqualTo(37));
        }
        ...
        public void TestInvokeMemberSuper() {
            ...
            var testClassBase = new DragonClass("TestBase", global::IronDragon.Dragon.Box(typeof (object)),
                new List<DragonFunction>(),
                new List<DragonFunction> {scope.GetVariable("test")});
            ...
            Assert.That(nsource.Execute(nscope), NUnit.Framework.Is.EqualTo(35));
        }
        ...
        public void TestInvokeMemberSuperCSharp() {
            ...
            Assert.That((int)x.test(10), NUnit.Framework.Is.EqualTo(35));
        }
        ...
        public void TestInvokeMemberSuperIronRuby() {
            ...
            Assert.That((int)rubysource.Execute(rubyscope), NUnit.Framework.Is.EqualTo(35));
        }
        ...
        public void TestSetGetMember() {
            ...
            Assert.That(nsource.Execute(nscope), NUnit.Framework.Is.EqualTo(20));
        }
        ...
        public void TestSetGetMemberInBody() {
            ...
            Assert.That(nsource.Execute(nscope), NUnit.Framework.Is.EqualTo(22));
        }

        [Test]
        public void TestDragonDoNotExportAttribute() {
            DragonClass klass = global::IronDragon.Dragon.Box(typeof (ExportHelper));
            var engine = GetRuntime().GetEngine("IronDragon");
        ...
        public void TestDragonExportAttribute() {
            ...
            var scope = engine.CreateScope();
            scope.SetVariable(klass.Name, klass);
            Assert.That(source.Execute(scope), NUnit.Framework.Is.EqualTo(40));
        }
        ...
        public void TestDragonObjectBinaryCSharp() {
            ...
            dynamic testClass = new DragonClass("Test", global::IronDragon.Dragon.Box(typeof (object)), new List<DragonFunction>(),
                new List<DragonFunction> {scope.GetVariable("+")});
        ...
        public void TestSingleton() {
            ...
            Assert.That(nsource.Execute(nscope), NUnit.Framework.Is.EqualTo(expect));
        }
        ...
        public void TestSubModule()
        {
            ...
            Assert.That(
                ...
                NUnit.Framework.Is.EqualTo(expect));
        }
        ...
        public void TestClassOpening()
        {
            Assert.That(
                ...
                NUnit.Framework.Is.EqualTo(127));
        }
        ...
        public void TestCodeEval()
        {
            Assert.That(CompileAndExecute("def evalTest(s) { code = <<-CODE def test() { return 7; }; CODE; s.class_eval(code); }; class PropTest { evalTest(self()); }; x = PropTest(); x.test;"),
                NUnit.Framework.Is.EqualTo(7));
        }

        [Test]
        public void TestClassEval()
        {
            Assert.That(CompileAndExecute("class TestClassEval { def test() { return 7; }; }; x = TestClassEval(); x.class_eval('def test2() { return 25; };'); x.test2;"), NUnit.Framework.Is.EqualTo(25));
        }

        [Test]
        public void TestInstanceEval()
        {
            Assert.That(CompileAndExecute("class TestClassEval2 { def test() { @x = 17; }; }; x = TestClassEval2(); x.test; x.instance_eval('@x;');"), NUnit.Framework.Is.EqualTo(17));
        }
        ...
        {
            Assert.That(
                CompileAndExecute("class UndefSingletonTest { def test { return 25; }; }; UndefSingletonTest.undef_method :test; x = UndefSingletonTest(); begin { x.test; } rescue * { nil; };"), NUnit.Framework.Is.Null);
        }
        ...
        public void TestInstanceSingletonRemoveMethod()
        {
            ...
            Assert.That(
                CompileAndExecute("class RemoveMethodSingletonSuperTest { def test { return nil; }; }; class RemoveMethodSingletonSubTest < RemoveMethodSingletonSuperTest { def test { return 25; }; }; x = RemoveMethodSingletonSubTest(); y = RemoveMethodSingletonSubTest(); y.remove_method :test; [x.test, y.test];"), NUnit.Framework.Is.EqualTo(expect));
        }
        ...
        {
            Assert.That(
                CompileAndExecute("def funcMacro(n, r) { code = <<-CODE def testFunc#{n} { return '#{r}'; }; CODE; code; }; class MacroTest { self.class_eval(funcMacro('Test', 'Hello world!')); }; x = MacroTest(); x.testFuncTest();"), NUnit.Framework.Is.EqualTo("Hello world!"));
        }
    }
}