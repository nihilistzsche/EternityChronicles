...
namespace ECX.Core.Module
{
    ...
    public class ModuleInfo {
		...
		public ModuleInfo (Assembly assembly) {
			...
			if (_depAttr.Any ()) {
				ECXLexer _lexer = new ECXLexer(new ANTLRStringStream(((ModuleDependencyAttribute)_depAttr.First ()).DepString));
				ECXParser _parser = new ECXParser(new CommonTokenStream(_lexer));
		...
		/// </summary>
		/// <remarks>None.</remarks>
		public DepVersion Version { get; protected set; }
		
		/// <summary>
		/// Gets the modules dependency tree.
		/// </summary>
		/// <remarks>None.</remarks>
		public DepNode Dependencies { get; protected set; }
		...
		/// </summary>
		/// <remarks>None.</remarks>
		public Assembly Owner { get; protected set; }
	}		
}
