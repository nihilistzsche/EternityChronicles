...
public partial class DragonParserBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IDragonParserVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="DragonParser.range_op"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitRange_op([NotNull] DragonParser.Range_opContext context) { return VisitChildren(context); }

	/// <summary>
	/// Visit a parse tree produced by <see cref="DragonParser.range_expression"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitRange_expression([NotNull] DragonParser.Range_expressionContext context) { return VisitChildren(context); }
