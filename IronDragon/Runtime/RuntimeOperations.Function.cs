    ...
    public static partial class RuntimeOperations {
        ...
        internal static dynamic Call(object func, List<FunctionArgument> args, object scope, DragonExpressionType pipeType, bool isOp, bool isPostfix) {
            ...
            if (func is DragonFunction && !(func is DragonPartialFunction)) {
                ...
                if (isOp) {
                    imArgs.Add(Expression.Constant(new DragonUnaryBoolean(isPostfix)));
                }
        ...
        internal static dynamic Yield(object function, List<FunctionArgument> values, object scope) {
            if (!(function is MulticastDelegate)) return Call(function, values, scope, DragonExpressionType.Empty, false, false);
        ...
        internal static dynamic Invoke(Type targetType, MethodBase minfo, List<FunctionArgument> args,
            ...
            args.ForEach(arg => {
                ...
                if (_val is DragonString) {
                    _val = (string) _val;
                }
                if (_val is DragonNumber)
                {
                    _val = DragonNumber.Convert((DragonNumber) _val);
                }
                arguments.Add(_val);
            });
